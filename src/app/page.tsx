...
<section className="min-h-screen bg-orange-600 md:bg-gradient-to-r md:from-orange-400 md:via-orange-600 md:to-black flex items-center">
  <div className="mx-auto flex flex-col justify-between md:flex-row items-center p-4 md:p-10 min-h-screen">
    {/* Texto à esquerda */}
    <div className="md:mr-40 w-full md:w-1/2 text-left text-white">
      ...
      <p className="relative inline-block mt-4 text-white text-lg md:text-xl bg-black px-4 md:px-6 py-2 md:py-3 pr-12 md:pr-20 shadow-md" style={{ clipPath: "polygon(100% 0, 80% 90%, 0 90%, 0 0)" }}>
        Em Blumenau/SC
      </p>
    ...
    <div className="flex justify-center w-full mt-6 md:mt-0 md:w-auto self-end md:self-center">
      <Image
...
<div className="w-full bg-white flex justify-center items-center">
  <section className="w-full bg-gradient-to-r from-orange-400 via-orange-600 to-orange-400">
    <div className="container mx-auto flex flex-col md:flex-row items-center px-4 md:px-0"> {/* Ajustado para flex-col em telas pequenas */}
      ...
      <div className="w-full md:w-1/2 relative mb-6 md:mb-0 flex justify-center mt-4 md:mt-0"> {/* Adicionada margem superior no mobile */}
        <Image
        ...
        <Image
          ...
          height={300}
          objectFit="cover"
          className="hidden md:block w-full h-full" // Exibe apenas no desktop
        />
      </div>

      {/* Texto e botões à direita */}
      <div className="w-full md:w-1/2 text-white md:pl-10 md:text-left">
        ...
        {/* Renda e botão */}
        <p className="text-2xl md:text-3xl mb-4 text-center font-swis721">
...
<div className="relative w-full h-screen flex md:block items-center justify-center">
  <Image
    src="/imagens/section3-.png" // Substitua pela URL correta da imagem
    alt="Imagem do empreendimento"
    layout="fill"  // Preenche toda a tela
    objectFit="cover" // A imagem se ajustará sem cortar, cobrindo toda a tela
    className="z-0 opacity-80" // Ajuste na opacidade para destacar os ícones e textos
  />

  {/* Gradiente sobre a imagem para melhor visibilidade dos textos */}
  <div className="absolute inset-0 bg-gradient-to-l from-orange-800 to-transparent md:bg-gradient-to-r"></div>

  {/* Texto e ícones centralizados - apenas para mobile */}
  <div className="relative z-10 flex flex-col items-center text-white max-w-full px-4 md:hidden text-center">
    <ul className="space-y-6 text-2xl">
      <li className="flex flex-col items-center gap-2">
        <BedDouble className="w-8 h-8" /> {/* Ícones ajustados para mobile */}
    ...
    {/* Botão ajustado abaixo dos ícones e textos */}
    <div className="mt-8">
      <a
        href="https://wa.me/5547996984421"
        target="_blank"
  ...
  {/* Configurações para telas maiores (desktop) */}
  <div className="hidden md:flex absolute right-28 top-1/4 text-white max-w-md text-2xl">
...
<section className="min-h-screen bg-orange-600 md:bg-gradient-to-r md:from-orange-400 md:via-orange-600 md:to-black flex items-center">
  <div className="container mx-auto flex flex-col md:flex-row items-center justify-center p-2">
    {/* Texto à esquerda */}
    <div className="md:w-1/2 text-left text-white flex flex-col justify-center mt-2 md:mt-0">
